...
// Headers de seguridad aplicados a TODAS las respuestas del demo server.
// El CSP principal viaja como meta tag en el HTML buildado (por app, distinta
// policy en landing vs admin); acá se agregan los headers que el meta no
// puede expresar (frame-ancestors) más la protección estándar.
const SECURITY_HEADERS = {
    'x-content-type-options': 'nosniff',
    'x-frame-options': 'SAMEORIGIN',
    'referrer-policy': 'strict-origin-when-cross-origin',
    'permissions-policy': 'geolocation=(), microphone=(), camera=()',
    // Additivo con el meta CSP: 'self' permite el iframe same-origin de
    // SitePage (src="/") y bloquea clickjacking cross-origin.
