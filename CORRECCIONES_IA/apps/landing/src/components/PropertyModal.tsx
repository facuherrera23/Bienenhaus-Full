    ...
    >
      ...
      >
        ...
        <div className={styles.modalGallery}>
          <div className={styles.modalMainImage}>
            ...
            <div className={styles.modalBadges}>
              {property.featured && (
                <span className={`${styles.badge} ${styles.badgeFeatured}`}>Destacada</span>
              )}
        ...
        <div className={styles.modalContent}>
          <div className={styles.modalHeader}>
            <div className={styles.modalMeta}>
              ...
              <button className={styles.shareBtn} aria-label="Compartir">
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                  ...
                  <path d="M6.5 7.5L11.5 5.5" stroke="currentColor" strokeWidth="1.5"/>
                  <path d="M6.5 10.5L11.5 12.5" stroke="currentColor" strokeWidth="1.5"/>
                </svg>
              </button>
            </div>
            ...
            <div className={styles.modalLocation}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <path d="M8 15C11 12.5 13.5 10 13.5 6.5C13.5 3.46243 11.0376 1 8 1C4.96243 1 2.5 3.46243 2.5 6.5C2.5 10 5 12.5 8 15Z" stroke="currentColor" strokeWidth="1.5"/>
              </svg>
              {property.location}
            </div>
            ...
            <div className={styles.modalFeature}>
              <div className={styles.featureIcon}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  <rect x="0.5" y="0.5" width="19" height="19" stroke="currentColor" strokeWidth="1.5"/>
                  <path d="M0.5 10H19.5" stroke="currentColor" strokeWidth="1.5"/>
                  <path d="M10 0.5V19.5" stroke="currentColor" strokeWidth="1.5"/>
                </svg>
              </div>
            ...
            <div className={styles.modalFeature}>
              <div className={styles.featureIcon}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                  ...
                  <path d="M10 2V10L14 14" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
                </svg>
              </div>
              <div className={styles.featureInfo}>
          ...
          {/* Video */}
          {hasVideo && (
            <div className={`${styles.modalVideo} ${isVideoPlaying ? styles.videoPlaying : ''}`}>
