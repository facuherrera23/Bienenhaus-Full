import type { BrowserClientOptions, SeverityLevel } from '@sentry/browser';
...
let sentry: {
    init: (options: BrowserClientOptions) => void;
    captureException: (error: unknown, options?: { extra?: Record<string, unknown> }) => void;
    captureMessage: (message: string, options?: { level?: SeverityLevel; extra?: Record<string, unknown> }) => void;
