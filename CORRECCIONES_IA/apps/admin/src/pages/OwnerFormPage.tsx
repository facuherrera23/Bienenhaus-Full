...
import { useCreateOwner, useOwner, useUpdateOwner } from '@lib/owners/api';
        ...
        return (
            <div className="page">
                ...
                <div className="card placeholder-card">
                    No se pudo cargar el propietario: {error?.message}
                </div>
            </div>
        );
    }
            ...
            <div className="page-head">
                ...
                <div>
                    ...
                    <p className="page-subtitle">
                        {isNew
                            ? 'Registrá un nuevo propietario en la cartera.'
