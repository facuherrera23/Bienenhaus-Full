...
import { X, User, Mail, MapPin, FileText } from 'lucide-preact';
...
export function OwnerForm({ initialData, onSubmit, onCancel, isLoading, submitLabel = 'Guardar' }: OwnerFormProps) {
