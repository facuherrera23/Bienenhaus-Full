...
describe('OwnerForm', () => {
    ...
    it('shows company_name field when owner_type is persona_juridica', () => {
        render(
            <OwnerForm
                onSubmit={mockSubmit}
                initialData={{ ...validData, owner_type: 'persona_juridica' }}
            />,
        );
    ...
    it('hides company_name field when owner_type is persona_fisica', () => {
        render(
            <OwnerForm
                onSubmit={mockSubmit}
                initialData={{ ...validData, owner_type: 'persona_fisica' }}
            />,
        );
    ...
    it('keeps user edits when initialData reference changes but values do not', () => {
        ...
        // (p. ej. OwnerDetailPage con queries hermanas resolviendo).
        rerender(<OwnerForm onSubmit={mockSubmit} initialData={{ ...validData }} />);
