        ...
        <div className="page action-plan-detail-page">
            ...
            {editingPlan && (
                <div className="card form-card">
                    <form
                        onSubmit={planMethods.handleSubmit(handlePlanSubmit)}
                        className="plan-form"
                    >
                        ...
                        <div className="field full-width">
                            ...
                            <textarea
                                id="description"
                                rows={3}
                                {...planMethods.register('description')}
                            />
                        </div>
            ...
            <div className="plan-detail-grid">
                <div className="plan-main">
                    <ActionPlanCard plan={plan} tasks={tasks ?? []} />
                    ...
                    <div className="detail-card">
                        ...
                        <dl className="detail-list">
                            ...
                            {plan.due_date && (
                                <>
                                    <dt className={isOverdue ? 'overdue-label' : ''}>
                                        Fecha límite
                                    </dt>
                            ...
                            {plan.assigned_to_name && (
                                <>
                                    <dt>Asignado a</dt>
                                    <dd>
                                        <User size={14} /> {plan.assigned_to_name}
                                    </dd>
                                </>
                            )}
                            {plan.owner_name && (
                        ...
                        <form onSubmit={taskMethods.handleSubmit(handleTaskSubmit)}>
                            ...
                            <div className="form-grid">
                                <div className="field">
                                    ...
                                    <input
                                        id="task_title"
                                        type="text"
                                        placeholder="Ej: Contactar propietario para revisar precio"
                                        {...taskMethods.register('title')}
                                    />
                                </div>
                                <div className="field">
                            ...
                            <div className="field full-width">
                                ...
                                <textarea
                                    ...
                                    {...taskMethods.register('description')}
                                />
                            </div>
