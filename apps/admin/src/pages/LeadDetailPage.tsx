...
export function LeadDetailPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      pushToast({ type: 'success', title: 'Cambios guardados', description: `${lead?.name} ${lead?.last_name}` });
    } catch {
    ...
    <div className="page">
      <div className="page-head">
        <div>
          ...
          <p className="page-subtitle">Información de contacto y seguimiento comercial.</p>
        </div>
        ...
        <div className="lead-detail">
          <div className="lead-hero">
            ...
            <div className="lead-hero-info">
              ...
              <p>
                {LEAD_INTENT_LABEL[lead.intent]} · {LEAD_SOURCE_LABEL[lead.source]} · Recibido{' '}
          ...
          <div className="lead-grid">
            <section className="form-section">
              <div className="form-section-head">
                <h3>Contacto</h3>
                <p>Datos del lead. {lead.property_title ? `Interesado en: ${lead.property_title}` : ''}</p>
              </div>
              ...
              <div className="form-grid">
                <label className="field">
                  ...
                  <select
                    className="select"
                    value={status}
                    onChange={(e) => setStatus((e.currentTarget as HTMLSelectElement).value as LeadStatus)}
                  >
                ...
                <label className="field">
                  ...
                  <select
                    className="select"
                    value={assignedTo}
                    onChange={(e) => setAssignedTo((e.currentTarget as HTMLSelectElement).value)}
                  >
