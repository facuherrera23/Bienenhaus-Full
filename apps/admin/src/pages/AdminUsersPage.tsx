...
export function AdminUsersPage() {
    ...
    const handleResetPassword = async (email: string) => {
        try {
            ...
            if (res.link) {
                ...
                pushToast({
                    type: 'success',
                    title: 'Link de recuperación copiado al portapapeles',
                });
            } else {
    ...
    return (
        <div className="page">
            ...
            {isError && (
                <div className="card placeholder-card">No se pudieron cargar los usuarios.</div>
            )}
                ...
                >
                    ...
                    >
                        ...
                        <div className="modal-content">
                            ...
                            <p className="muted">
                                Recibirá un email para definir su contraseña y acceder al panel.
                            </p>
                                    ...
                                    <label className="field field--wide">
                                        ...
                                        <input
                                            ...
                                            onInput={(e) =>
                                                setInviteForm({
                                                    ...inviteForm,
                                                    email: (e.currentTarget as HTMLInputElement)
                                                        .value,
                                                })
                                            }
                                            required
                                    ...
                                    <label className="field field--wide">
                                        ...
                                        <input
                                            ...
                                            onInput={(e) =>
                                                setInviteForm({
                                                    ...inviteForm,
                                                    full_name: (e.currentTarget as HTMLInputElement)
                                                        .value,
                                                })
                                            }
                                            required
