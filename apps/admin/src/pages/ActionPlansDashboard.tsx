...
import { Plus, Filter, FileText, Search, X, Trash2, RotateCcw, Check } from 'lucide-preact';
    ...
    <div className="page action-plans-dashboard">
      <div className="page-head">
        <div>
          ...
          <p className="page-subtitle">
            Vista global de todos los planes del equipo.
          </p>
        </div>
          ...
          <div className="filter-row">
            ...
            <div className="filter-group">
              ...
              <select
                ...
                onChange={(e) => setAssignedFilter((e.currentTarget as HTMLSelectElement).value as any)}
              >
                <option value="todos">Todos</option>
      ...
      {!loading && filtered.length === 0 && (
        <div className="card placeholder-card">
          ...
          <p>{activeTab === 'active' ? 'No hay planes que coincidan con la búsqueda.' : 'No hay planes eliminados.'}</p>
          {activeTab === 'active' && (
            <Link href="/planes-accion/nuevo" className="btn btn--primary">
                  ...
                  >
                    ...
                    <td>
                      <div className="row-actions">
                        {activeTab === 'active' && plan.status !== 'completed' && (
                          <button
                            className="icon-btn"
                            title="Completar"
                        ...
                        <button
                          className="icon-btn"
                          title={activeTab === 'active' ? 'A papelera' : 'Restaurar'}
                          onClick={(e) => {
                            e.stopPropagation();
                            if (activeTab === 'active') handleSoftDelete(plan.id, plan.title);
                        ...
                        {activeTab === 'deleted' && (
                          <button
                            ...
                            onClick={(e) => { e.stopPropagation(); handlePermanentDelete(plan.id, plan.title); }}
                          >
                            <Trash2 size={14} />
                          </button>
                        )}
