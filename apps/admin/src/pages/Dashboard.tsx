...
export function Dashboard() {
    ...
    const kpis = [
        ...
        },
        {
            label: 'Leads Activos',
            value: activeLeads,
            delta: `Conversión ${conversionRate}%`,
            icon: TrendingUp,
            tone: 'success',
        },
        {
        ...
        {
            label: 'Valor Pipeline (ARS)',
            value: pipelineValueARS > 0 ? `$${pipelineValueARS.toLocaleString('es-AR')}` : '—',
            delta: `solo venta`,
            icon: DollarSign,
            tone: 'info',
        },
        ...
        {
            label: 'Planes de Acción Pendientes',
            value: pendingPlans,
