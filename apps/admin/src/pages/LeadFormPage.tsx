    ...
    <div className="page">
      <div className="page-head">
        <div>
          ...
          <p className="page-subtitle">Carga manual de un contacto recibido fuera de la landing.</p>
        </div>
      ...
      <div className="card form-card">
        <section className="form-section">
          ...
          <div className="form-grid">
            ...
            <label className="field">
              <span>Apellido *</span>
              <input type="text" value={values.last_name} onInput={set('last_name')} />
            </label>
            <label className="field">
              <span>Email *</span>
        ...
        <section className="form-section">
          ...
          <div className="form-grid">
            <label className="field">
              <span>Intención</span>
              <select className="select" value={values.intent} onChange={set('intent')}>
            ...
            <label className="field">
              <span>Origen</span>
              <select className="select" value={values.source} onChange={set('source')}>
            ...
            <label className="field">
              ...
              <select className="select" value={values.assigned_to} onChange={set('assigned_to')}>
