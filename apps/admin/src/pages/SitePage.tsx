...
export function SitePage() {
    ...
    const settingsMap = useMemo(
        () => new Map((settingsQ.data ?? []).map((s) => [s.key, s])),
        [settingsQ.data],
    );
                                ...
                                >
                                    <div className={styles['site-row-head']}>
                                        ...
                                        <div className={styles['site-row-active']}>
                                            ...
                                            />
                                            <span>
                                                {entry.isActive ? 'Activado' : 'Desactivado'}
                                            </span>
                                        </div>
                                    </div>
                                    <ListEditor
    ...
    const SETTINGS_GROUPS = [
        {
            ...
            icon: '🎬',
            description:
                'Configuración del video principal del Hero (sección principal de la landing)',
            keys: [
                'hero_video_url',
                'hero_video_title',
                'hero_video_autoplay',
        ...
        },
        {
            ...
            icon: '🌐',
            description:
                'Links a redes sociales (Instagram, Facebook, YouTube, TikTok, LinkedIn, WhatsApp)',
            keys: ['social'],
        },
        {
            id: 'company',
            ...
            <section className={`card ${styles['site-section']} settings-section`}>
                ...
                <div className={`${styles['site-section-body']} settings-body`}>
                    {SETTINGS_GROUPS.map((group) => {
                        ...
                        const groupDirtyCount = groupKeys.filter((k) =>
                            settingsDirty.some((s) => s.key === k),
                        ).length;
                            ...
                            <details key={group.id} className="settings-group" open>
                                ...
                                <div className="settings-group-body">
                                    {groupKeys.map((key) => {
                                        ...
                                        const fields =
                                            settingFieldsFor(s.key) ?? genericFields(s.value);
                                                ...
                                                <div className="site-row-field">
                                                    {isImage ? (
                                                        <ImageInput
                                                            ...
                                                            onChange={(url) =>
                                                                setSettingField(s.id)('value', url)
                                                            }
                                                        />
                                                    ) : (
                                                        <div className="form-grid">
