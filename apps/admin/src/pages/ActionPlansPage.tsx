...
import { ArrowLeft, Plus, FileText, X } from 'lucide-preact';
    ...
    <div className="page action-plans-page">
      <div className="page-head">
        ...
        <div>
          ...
          <p className="page-subtitle">Gestioná los planes de acción para esta propiedad.</p>
        </div>
        <button
          type="button"
        ...
        <div className="card form-card">
          <form onSubmit={methods.handleSubmit(handleSubmit)} className="plan-form">
            <div className="form-header">
              ...
              <button type="button" className="icon-btn" onClick={() => setShowNewPlan(false)}>
                <X size={18} />
              </button>
            </div>
            ...
            <div className="field full-width">
              ...
              <textarea id="description" rows={3} placeholder="Detalles del plan..." {...methods.register('description')} />
            </div>

            <div className="form-actions">
              <button type="button" className="btn btn--ghost" onClick={() => setShowNewPlan(false)}>
                <X size={14} /> Cancelar
              </button>
              <button type="submit" className="btn btn--primary" disabled={createActionPlan.isPending}>
      ...
      <div className="toolbar">
        <div className="toolbar-filters">
          ...
          <select
            ...
            onChange={(e) => setCategoryFilter((e.currentTarget as HTMLSelectElement).value as any)}
          >
          ...
          <select
            ...
            onChange={(e) => setPriorityFilter((e.currentTarget as HTMLSelectElement).value as any)}
          >
      ...
      {!isLoading && !isError && filteredPlans.length === 0 && (
        <div className="empty-state">
          ...
          <button type="button" className="btn btn--primary" onClick={() => setShowNewPlan(true)}>
