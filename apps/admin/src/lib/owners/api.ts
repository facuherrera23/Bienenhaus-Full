...
export const propertyOwnersKeys = {
    ...
    byProperty: (propertyId: string) =>
        [...propertyOwnersKeys.all, 'property', propertyId] as const,
    ...
    return useMutation({
        ...
        onSuccess: (data) => {
            queryClient.invalidateQueries({
                queryKey: propertyOwnersKeys.byProperty(data.property_id),
            });
...
export function useCreatePriceAnalysis() {
    ...
    return useMutation({
        ...
        onSuccess: (data) => {
            queryClient.invalidateQueries({
                queryKey: priceAnalysisKeys.current(data.property_id),
            });
            queryClient.invalidateQueries({
                queryKey: priceAnalysisKeys.history(data.property_id),
            });
        },
    });
}
