...
const mockMessages = [
    { id: 'msg-1', channel_id: 'ch-1', sender_id: 'agent-1', content: 'Hola', message_type: 'text', reply_to_id: null, created_at: '2024-01-01T10:00:00Z' },
    { id: 'msg-2', channel_id: 'ch-1', sender_id: 'agent-2', content: 'Hola!', message_type: 'text', reply_to_id: 'msg-1', created_at: '2024-01-01T10:05:00Z' },
    { id: 'msg-3', channel_id: 'ch-1', sender_id: 'agent-1', content: '¿Cómo estás?', message_type: 'text', reply_to_id: 'msg-2', created_at: '2024-01-01T10:10:00Z' },
    { id: 'msg-4', channel_id: 'ch-1', sender_id: 'agent-1', content: 'Otro tema', message_type: 'text', reply_to_id: null, created_at: '2024-01-01T11:00:00Z' },
];
