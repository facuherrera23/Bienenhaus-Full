...
export function validateVisitForm(
    data: unknown,
): { valid: boolean; error?: string; data?: VisitFormValues } {
...
export function validateVisitPatch(
    data: unknown,
): { valid: boolean; error?: string; data?: VisitPatch } {
...
export function validateQrCheckin(
    data: unknown,
): { valid: boolean; error?: string; data?: QrCheckinPayload } {
