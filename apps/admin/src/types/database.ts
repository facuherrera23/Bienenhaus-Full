...
export type Database = {
    ...
    public: {
        Tables: {
            ...
            owners: {
                Row: {
                    ...
                    phone: string | null;
                    preferred_contact:
                        Database['public']['Enums']['owner_preferred_contact'] | null;
                    updated_at: string | null;
                };
                Insert: {
                    address?: string | null;
        ...
        Enums: {
            action_plan_category: 'pricing' | 'marketing' | 'condition' | 'legal' | 'other';
            ...
            communication_type: 'email' | 'whatsapp' | 'call' | 'meeting' | 'report' | 'note';
            content_section:
                | 'hero'
                | 'catalogo'
                | 'servicios'
            ...
            price_status: 'way_below' | 'below' | 'fair' | 'above' | 'way_above' | 'premium';
            property_status:
                | 'borrador'
                | 'en_revision'
                | 'publicada'
