...
export const signInWithPassword = vi.fn().mockResolvedValue({ data: { user: null, session: null }, error: null });
...
vi.mock('wouter-preact', () => ({
  ...
  Route: ({ component: Component, ...props }: { component: React.ComponentType<any>; [key: string]: any }) => (
    <Component {...props} />
  ),
}));
...
vi.mock('lucide-preact', () => {
  const icons = [
    'Activity', 'AlertCircle', 'ArrowLeft', 'ArrowUpRight', 'BarChart2', 'Building2',
    'Calendar', 'Check', 'CheckCircle', 'ChevronDown', 'Clock', 'DollarSign',
    'Download', 'Edit', 'FileText', 'Filter', 'Globe', 'Home', 'LayoutDashboard',
    'Loader2', 'Mail', 'MapPin', 'MessageSquare', 'MoreVertical', 'Phone', 'Plus',
    'RotateCcw', 'Save', 'Search', 'Send', 'Settings', 'Shield', 'ShoppingBag',
    'Target', 'TrendingDown', 'TrendingUp', 'Trash2', 'User', 'UserCheck',
