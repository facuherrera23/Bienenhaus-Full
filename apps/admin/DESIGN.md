...
7. **Tables** — Sticky headers, row selection, hover states
8. **Modals** — Backdrop blur, consistent shadows
9. **QA** — Visual regression at 375/768/1280px, interaction states, motion

---

*This document is the contract. All visual changes must trace to a token or rule defined here.*