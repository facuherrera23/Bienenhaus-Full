...
export function Contact() {
    ...
    const handleChange = (e: Event) => {
        ...
        const checked =
            target instanceof HTMLInputElement && type === 'checkbox' ? target.checked : undefined;
        setFormData((prev) => ({
            ...prev,
                    ...
                    >
                        ...
                        <div className={styles.contactInfoItem}>
                            ...
                            <div className={styles.content}>
                                ...
                                <span className={styles.value}>
                                    bienenhaus.propiedades@gmail.com
                                </span>
                            </div>
                        </div>
                        ...
                        <div className={styles.contactInfoItem}>
                            <div className={styles.icon}>
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <path
                                        d="M4 2L6 5L4.5 7L6.5 10L8.5 12L10.5 10.5L13 12L15 14"
                                        stroke="currentColor"
                                        strokeWidth="1.5"
                                        strokeLinecap="round"
                                    />
                        ...
                        <div className={styles.contactInfoItem}>
                            <div className={styles.icon}>
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    ...
                                    />
                                    <path
                                        d="M9 17C13 13.5 16 10.5 16 7.5C16 3.63401 12.866 0.5 9 0.5C5.13401 0.5 2 3.63401 2 7.5C2 10.5 5 13.5 9 17Z"
                                        stroke="currentColor"
                                        strokeWidth="1.5"
                                    />
                                </svg>
                        ...
                        <div className={styles.contactSocial}>
                            ...
                            <a href="#" className={styles.socialCircle} aria-label="Facebook">
                                <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    <path
                                        d="M12 3H10.5C9.11929 3 8 4.11929 8 5.5V7.5H6V10.5H8V15.5H11V10.5H13L13.5 7.5H11V5.5C11 5.22386 11.2239 5 11.5 5H13.5V3H12Z"
                                        stroke="currentColor"
                                        strokeWidth="1.5"
                                        strokeLinecap="round"
                            ...
                            <form onSubmit={handleSubmit} noValidate>
                                ...
                                <div className={styles.formIndicators}>
                                    <div className={styles.formIndicator}>
                                        ...
                                        <span>
                                            Respuesta en{' '}
                                            <span className={styles.highlight}>24hs</span>
                                        </span>
                                    </div>
                                    <div className={styles.formIndicator}>
                                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                                ...
                                <div className={styles.formRow}>
                                    <div
                                        className={`${styles.formGroup} ${errors.name ? styles.error : ''}`}
                                    >
                                        <div className={styles.inputWrapper}>
                                            ...
                                            <span className={styles.inputIcon}>
                                                ...
                                                >
                                                    ...
                                                    />
                                                    <path
                                                        d="M2 14V13C2 10.2386 4.23858 8 7 8H9C11.7614 8 14 10.2386 14 13V14"
                                                        stroke="currentColor"
                                                        strokeWidth="1.5"
                                                        strokeLinecap="round"
                                                    />
                                    ...
                                    <div
                                        className={`${styles.formGroup} ${errors.lastName ? styles.error : ''}`}
                                    >
                                        <div className={styles.inputWrapper}>
                                            <input
                                                type="text"
                                ...
                                <div className={styles.formRow}>
                                    ...
                                    <div
                                        className={`${styles.formGroup} ${errors.phone ? styles.error : ''}`}
                                    >
                                        <div className={styles.inputWrapper}>
                                            <input
                                                type="tel"
                                            ...
                                            <span className={styles.inputIcon}>
                                                ...
                                                >
                                                    <path
                                                        d="M3 2L5 4L4 6L6 8L8 10L9 9L11 10L13 12"
                                                        stroke="currentColor"
                                                        strokeWidth="1.5"
                                                        strokeLinecap="round"
                                                    />
                                    ...
                                    <div className={styles.inputWrapper}>
                                        ...
                                        <span className={styles.inputIcon}>
                                            ...
                                            >
                                                ...
                                                />
                                                <path
                                                    d="M8 15C11 12.5 13.5 10 13.5 7C13.5 3.96243 11.0376 1.5 8 1.5C4.96243 1.5 2.5 3.96243 2.5 7C2.5 10 5 12.5 8 15Z"
                                                    stroke="currentColor"
                                                    strokeWidth="1.5"
                                                />
                                            </svg>
                                ...
                                {/* Privacidad */}
                                <div
                                    className={`${styles.formGroup} ${styles.checkboxGroup} ${errors.privacy ? styles.error : ''}`}
                                >
                                    <input
                                        type="checkbox"
                                        id="privacy"
                                ...
                                {errors.privacy && (
                                    <span className={styles.errorMessage}>{errors.privacy}</span>
                                )}
                                ...
                                <RippleEffect>
                                    ...
                                    >
                                        ...
                                        <span className={styles.btnText}>Enviar consulta</span>
                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                                            <path
                                                d="M3 9H15"
                                                stroke="currentColor"
