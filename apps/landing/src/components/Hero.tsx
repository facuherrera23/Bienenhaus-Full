...
import { useCountUp, useMouseGlow, useRipple, useScrollAnimation } from '@/lib/motion';
            ...
            <div className={styles.heroBg}>
                <picture>
                    ...
                    <source
                        ...
                        type="image/avif"
                        srcSet="/assets/images/hero/hero-baner-xl.avif"
                    />
                    <source
                        media="(min-width: 1440px)"
                        type="image/webp"
                        srcSet="/assets/images/hero/hero-baner-xl.webp"
                    />
                    <source
                        media="(min-width: 1024px)"
                        type="image/avif"
                        srcSet="/assets/images/hero/hero-baner-lg.avif"
                    />
                    <source
                        media="(min-width: 1024px)"
                        type="image/webp"
                        srcSet="/assets/images/hero/hero-baner-lg.webp"
                    />
                    <source
                        media="(min-width: 768px)"
                        type="image/avif"
                        srcSet="/assets/images/hero/hero-baner-md.avif"
                    />
                    <source
                        media="(min-width: 768px)"
                        type="image/webp"
                        srcSet="/assets/images/hero/hero-baner-md.webp"
                    />
                    <source
                        media="(min-width: 480px)"
                        type="image/avif"
                        srcSet="/assets/images/hero/hero-baner-sm.avif"
                    />
                    <source
                        media="(min-width: 480px)"
                        type="image/webp"
                        srcSet="/assets/images/hero/hero-baner-sm.webp"
                    />
            ...
            <div className="container">
                <div className={styles.heroContent}>
                    ...
                    <div className={styles.heroLeft}>
                        ...
                        <span className={styles.eyebrow}>Bienenhaus Propiedades</span>
                        ...
                        <p className={styles.heroDesc}>
                            Propiedades exclusivas en las mejores zonas. Asesoramiento personalizado
                            en cada paso.
                        </p>
                    ...
                    <div className={styles.heroRight} ref={statsRef}>
                        <div className={styles.statsPanel}>
                            <div className={styles.statRow}>
                                <div className={styles.statIcon}>
                                    <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
                                        <path
                                            d="M3 12L5 10L9 14L13 10L19 16L21 14"
                                            stroke="currentColor"
                                            strokeWidth="1.5"
                                            strokeLinecap="round"
                                        />
                            ...
                            <div className={styles.statRow}>
                                ...
                                <div>
                                    <div className={styles.statNumber}>{clientsCount.value}+</div>
                            ...
                            <div className={styles.statRow}>
                                ...
                                <div>
                                    <div className={styles.statNumber}>{yearsCount.value}+</div>
