...
import { useParallax, useScrollAnimation, useTilt } from '@/lib/motion';
            ...
            <div className="container">
                ...
                >
                    <div className={styles.processHeaderLeft}>
                        ...
                        <p className={styles.processDesc}>
                            Un proceso estructurado y transparente para garantizar los mejores
                ...
                >
                    ...
                    <div className={styles.timelineLine} aria-hidden="true">
                        <div
                            className={`${styles.timelineLineProgress} ${timelineVisible ? styles.animated : ''}`}
                        />
                    </div>
                ...
                {/* Commitment Bar */}
                <div className={`${styles.commitmentBar} ${timelineVisible ? styles.visible : ''}`}>
