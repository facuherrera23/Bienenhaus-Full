...
import { useCountUp, useParallax, useScrollAnimation, useTilt } from '@/lib/motion';
            ...
            <div className="container">
                ...
                >
                    ...
                    <p className={styles.statsDesc}>
                        La confianza de nuestros clientes y los resultados obtenidos respaldan
                ...
                {/* CTA Inferior */}
                <div className={`${styles.statsCta} ${gridVisible ? styles.visible : ''}`}>
                    <div className={styles.statsCtaIcon}>
                        <span>🏆</span>
                        <span>Líderes en el mercado</span>
                    </div>
                    <p className={styles.statsCtaText}>
                        Unimos experiencia, innovación y compromiso para ofrecerte el mejor servicio
                        inmobiliario.
                    </p>
