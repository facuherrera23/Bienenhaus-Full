...
export function PropertyModal({
    ...
    const features = FEATURE_CONFIG.map((f) => ({ ...f, value: property[f.key] as number })).filter(
        (f) => (f.value as number) > 0,
    );
        ...
        >
            ...
            >
                ...
                <div className={styles.modalGallery} role="region" aria-label="Galería de imágenes">
                    <div className={styles.modalMainImage}>
                        ...
                        <div className={styles.modalBadges}>
                            ...
                            <span
                                className={`${styles.badge} ${styles.badgeOperation} ${property.operation === 'alquiler' ? styles.badgeOperationRent : styles.badgeOperationSale}`}
                            >
                ...
                <div className={styles.modalContent}>
                        ...
                        <div className={styles.modalMeta}>
                            {property.code && (
                                <span className={styles.propertyCode} id="modal-code">
                                    <HashIcon className={styles.icon} aria-hidden={true} /> Ref:{' '}
                                    {property.code}
                                </span>
                            )}
                    ...
                    <div
                        className={styles.modalFeatures}
                        role="list"
                    ...
                    {videoId && isVideoPlaying && (
                        <div
                            className={`${styles.modalVideo} ${styles.videoPlaying}`}
                            id="modal-video"
                        >
                            <h3>Video de la propiedad</h3>
                ...
                <div
                    className={styles.modalStickyCta}
                    role="complementary"
