            ...
            <div className="container">
                ...
                >
                    ...
                    <p className={styles.footerHeroDesc}>
                        Contactanos hoy y descubrí cómo podemos ayudarte a encontrar la propiedad
                        que estás buscando.
                    </p>
                ...
                >
                    ...
                    <div className={styles.footerColLogo}>
                        ...
                        <p className={styles.footerDesc}>
                            Selección premium de propiedades exclusivas en las mejores ubicaciones.
                    ...
                    <div className={styles.footerCol}>
                        ...
                        >
                            ...
                            {feedback.type && (
                                <div
                                    className={`${styles.footerNewsletterFeedback} ${feedback.type === 'success' ? styles.isOk : styles.isError}`}
                                >
                                    {feedback.message}
                                </div>
                            )}
                ...
                >
                    <div className={styles.footerBottomLeft}>
                        ...
                        <span className={styles.highlight}>BIENENHAUS PROPIEDADES</span>. Todos los
                        derechos reservados.
                    </div>
                    ...
                    <div className={styles.footerBottomRight}>
                        <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                            <path
                                d="M6 2L7.5 4.5L10 5L8 7.5L8.5 10L6 8.5L3.5 10L4 7.5L2 5L4.5 4.5L6 2Z"
                                fill="currentColor"
                            />
                        </svg>
                        Hecho con pasión
