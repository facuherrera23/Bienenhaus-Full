...
const servicesData: Service[] = [
    ...
    },
    {
        ...
        description:
            'Estrategias de marketing digital para maximizar la visibilidad de tu propiedad.',
    },
    {
        id: 6,
        icon: '🔒',
            ...
            <div className="container">
                ...
                >
                    ...
                    <p className={styles.servicesDesc}>
                        Ofrecemos un servicio integral y personalizado para que cada paso sea una
