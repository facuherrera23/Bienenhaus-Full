            ...
            items: [
                {
                    ...
                    text: 'Selección exclusiva de alta categoría',
                },
                {
                    icon: 'fa-handshake',
                    title: 'Asesoramiento Personalizado',
                    text: 'Acompañamiento profesional en cada etapa',
                },
                {
                    icon: 'fa-clipboard-list',
                    title: 'Gestión Integral',
                    text: 'Nos encargamos de todo. Vos elegís.',
                },
                {
                    icon: 'fa-clock',
                    title: 'Experiencia',
                    text: 'Más de 10 años conectando personas con hogares únicos',
                },
            ],
        },
    },
            ...
            items: [
                {
                    ...
                    description:
                        'Te ayudamos a encontrar la propiedad ideal que se adapta a tu estilo de vida y necesidades.',
                },
                {
                    icon: 'fa-hand-holding-usd',
                    title: 'Venta de propiedades',
                    description:
                        'Maximizamos el valor de tu propiedad con estrategias de marketing exclusivas y una amplia red de contactos.',
                },
                {
                    icon: 'fa-gavel',
                    title: 'Asesoramiento legal',
                    description:
                        'Acompañamiento legal en cada etapa del proceso para garantizar operaciones seguras y transparentes.',
                },
            ],
        },
    },
            ...
            items: [
                {
                    ...
                    title: 'Nos conocemos',
                    description:
                        'Escuchamos tus objetivos y necesidades para comprender exactamente qué estás buscando.',
                },
                {
                    icon: 'fa-chart-bar',
                    title: 'Analizamos la propiedad',
                    description:
                        'Realizamos una tasación profesional y definimos la mejor estrategia para maximizar su valor.',
                },
                {
                    icon: 'fa-bullhorn',
                    title: 'Diseñamos el plan',
                    description:
                        'Creamos una estrategia de marketing personalizada con difusión premium y posicionamiento.',
                },
                {
                    icon: 'fa-handshake',
                    title: 'Negociamos',
                    description:
                        'Gestionamos cada detalle y representamos tus intereses durante toda la negociación.',
                },
                {
                    icon: 'fa-key',
                    title: 'Concretamos la operación',
                    description:
                        'Te acompañamos hasta la firma y el cierre de la operación garantizando una experiencia impecable.',
                },
            ],
        },
    },
