...
const basicTabs: TabItem[] = [
    {
        id: 'overview',
        label: 'Overview',
        content: 'Overview panel — high-level summary of the property.',
    },
    {
        id: 'details',
        label: 'Details',
        content: 'Details panel — full specs, amenities, and floor plan.',
    },
            ...
            tabs={[
                {
                    ...
                    label: 'Home',
                    icon: <IconHome />,
                    content: <Panel>Home panel with a leading icon.</Panel>,
                },
                {
                    id: 'info',
                    label: 'Info',
                    icon: <IconInfo />,
                    content: <Panel>Info panel with a leading icon.</Panel>,
                },
                {
                    id: 'ratings',
                    label: 'Ratings',
                    icon: <IconStar />,
                    content: <Panel>Ratings panel with a leading icon.</Panel>,
                },
            ]}
        />
    ),
            ...
            tabs={[
                {
                    id: 'active',
                    label: 'Active',
                    content: <Panel>This tab is active and clickable.</Panel>,
                },
                {
                    id: 'locked',
                    label: 'Locked',
                    disabled: true,
                    content: <Panel>This panel is unreachable while the tab is disabled.</Panel>,
                },
                {
                    id: 'available',
                    label: 'Available',
                    content: <Panel>This tab is also clickable.</Panel>,
                },
            ]}
        />
    ),
...
export const PillsVariant: LocalStory = {
    render: () => <Tabs variant="pills" tabs={basicTabs} />,
};
...
export const ScrollableManyTabs: LocalStory = {
    render: () => {
        const manyTabs: TabItem[] = Array.from({ length: 12 }, (_, i) => ({
            ...
            content: (
                <Panel>
                    Content for section {i + 1}. The tablist scrolls horizontally when it overflows.
                </Panel>
            ),
        }));
        return (
...
export const AllVariants: LocalStory = {
    render: () => (
        ...
        >
            <div>
                <h3 style={{ fontSize: '14px', marginBottom: '8px', color: '#bfc6cc' }}>
                    Underline
                </h3>
