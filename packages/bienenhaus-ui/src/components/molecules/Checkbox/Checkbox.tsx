...
export const Checkbox = forwardRef<HTMLInputElement, CheckboxProps>(
  (
    ...
    const wrapperClass = ['checkbox', SIZE_CLASS[size], disabled && 'checkbox--disabled', className]
      .filter(Boolean)
      .join(' ');

    return (
      <div className={wrapperClass} data-checked={isChecked} data-indeterminate={indeterminate}>
        <input
          ref={setRefs}
          id={inputId}
          type="checkbox"
        ...
        <span className="checkbox__box" aria-hidden="true">
          {indeterminate ? (
            <svg className="checkbox__icon" viewBox="0 0 24 24" fill="none" aria-hidden="true">
