...
const meta: Meta<typeof Pagination> = {
  ...
  argTypes: {
    ...
    onPageChange: {
      action: 'pageChange',
      description: 'Called with the new page number when a page button or prev/next is clicked.',
    },
    pageSizeOptions: {
      control: 'object',
      description: 'Available page-size options. Renders the <select> only when pageSize + onPageSizeChange are also given.',
    },
    pageSize: {
      control: 'number',
