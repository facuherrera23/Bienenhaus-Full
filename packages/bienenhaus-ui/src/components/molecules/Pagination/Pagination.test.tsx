...
describe('Pagination', () => {
  ...
  it('renders page size selector when pageSize + onPageSizeChange + options given', () => {
    ...
    expect(screen.getByRole('combobox', { name: 'Cantidad de filas por página' })).toBeInTheDocument();
    // Options present
  ...
  it('accepts a custom aria-label', () => {
    ...
    expect(screen.getByRole('navigation', { name: 'Navegación de páginas' })).toBeInTheDocument();
  });
});
