...
export const Stacked: Story = {
  render: () => {
    const toasts: ToastItem[] = [
      { id: 1, type: 'success', title: 'Publicado en ML', description: 'La propiedad ya está visible.' },
      { id: 2, type: 'warning', title: 'Sincronización pendiente', description: '3 propiedades en cola.' },
      { id: 3, type: 'error', title: 'Fallo de conexión', description: 'Reintentando en 5s.' },
    ];
    return <ToastHost toasts={toasts} />;
  },
};
