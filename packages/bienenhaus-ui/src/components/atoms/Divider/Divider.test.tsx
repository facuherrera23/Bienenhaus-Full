...
describe('Divider', () => {
    ...
    it.each(['thin', 'medium', 'thick'] as const)('applies the %s thickness class', (thickness) => {
    ...
    it.each(['solid', 'dashed', 'dotted'] as const)('applies the %s variant class', (variant) => {
    ...
    it('passes through extra div attributes', () => {
        render(<Divider data-testid="custom" title="Section break" id="d1" />);
